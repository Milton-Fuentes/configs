...
@Entity
@Immutable
@Table(name = "dot_rub_d2240", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotRubD2240.findAll", query = "SELECT a FROM DotRubD2240 a")})
public class DotRubD2240 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "DUROMETER_HARDNESS_READINGS")
    private String durometerHardnessReadings;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "AVG_DUROMETER")
    private String avgDurometer;
    @Size(max = 50)
    ...
    public String getDurometerHardnessReadings() {
        return durometerHardnessReadings;
    }

    public void setDurometerHardnessReadings(String durometerHardnessReadings) {
        this.durometerHardnessReadings = durometerHardnessReadings;
    }
    ...
    public String getAvgDurometer() {
        return avgDurometer;
    }

    public void setAvgDurometer(String avgDurometer) {
        this.avgDurometer = avgDurometer;
    }
