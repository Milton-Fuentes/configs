...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwQaLabEquipInfoTestV2.findAll", query = "SELECT a FROM VwQaLabEquipInfoTestV2 a")})
public class VwQaLabEquipInfoTestV2 implements Serializable {
    ...
    public VwQaLabEquipInfoTestV2() {
    }

    public VwQaLabEquipInfoTestV2(BigDecimal id) {
        this.id = id;
    }
