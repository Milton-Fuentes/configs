...
@Table(name = "VW_QACONC_MIXDESG_MASTER_EXP", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwQaconcMixDesgMasterExp.findAll", query = "SELECT a FROM VwQaconcMixDesgMasterExp a")})
public class VwQaconcMixDesgMasterExp implements Serializable {
    ...
    public VwQaconcMixDesgMasterExp() {
    }
