...
@Entity
@Immutable
@Table(name = "dot_labr_t96", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotLabrT96.findAll", query = "SELECT a FROM DotLabrT96 a")})
public class DotLabrT96 implements Serializable {
