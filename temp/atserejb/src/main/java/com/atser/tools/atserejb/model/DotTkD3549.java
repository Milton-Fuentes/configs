...
@Entity
@Immutable
@Table(name = "DOT_TK_D3549", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotTkD3549.findAll", query = "SELECT a FROM DotTkD3549 a")})
public class DotTkD3549 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "THICKNESS3")
    private String thickness3;
    @Size(max = 50)
    @Column(name = "THICKNESS4")
    private String thickness4;
    @Size(max = 50)
    @Column(name = "AVG_THICKNESS")
    private String avgThickness;
    @Size(max = 4000)
    ...
    @Size(max = 50)
    @Column(name = "TARGET_THICKNESS")
    private String targetThickness;
    @Size(max = 50)
    @Column(name = "ENG_SPEC_PCT")
    private String engSpecPct;
    @Size(max = 50)
    @Column(name = "SPEC_PCT")
    private String specPct;
    @Size(max = 50)
    @Column(name = "ENG_SPEC_MIN")
    private String engSpecMin;
    @Size(max = 50)
    @Column(name = "ENG_SPEC_MAX")
    private String engSpecMax;
    @Size(max = 50)
    ...
    public String getAvgThickness() {
        return avgThickness;
    }

    public void setAvgThickness(String avgThickness) {
    ...
    public String getEngSpecPct() {
        return engSpecPct;
    }

    public void setEngSpecPct(String engSpecPct) {
        this.engSpecPct = engSpecPct;
    }
    ...
    public void setSpecPct(String specPct) {
        this.specPct = specPct;
    }

    public String getEngSpecMin() {
        return engSpecMin;
    }

    public void setEngSpecMin(String engSpecMin) {
        this.engSpecMin = engSpecMin;
    }

    public String getEngSpecMax() {
        return engSpecMax;
    }

    public void setEngSpecMax(String engSpecMax) {
        this.engSpecMax = engSpecMax;
    }
