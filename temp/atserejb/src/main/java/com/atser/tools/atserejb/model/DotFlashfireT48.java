...
@Entity
@Immutable
@Table(name = "DOT_FLASHFIRE_T48", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotFlashfireT48.findAll", query = "SELECT a FROM DotFlashfireT48 a")})
public class DotFlashfireT48 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "CORR_FLASH_POINT")
    private String corrFlashPoint;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "AVG_CORR_FLASH_POINT")
    private String avgCorrFlashPoint;
    @Size(max = 4000)
    ...
    @Size(max = 50)
    @Column(name = "AMBIENT_BAROMETRIC_PRESSURE")
    private String ambientBarometricPressure;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getCorrFlashPoint() {
        return corrFlashPoint;
    }

    public void setCorrFlashPoint(String corrFlashPoint) {
        this.corrFlashPoint = corrFlashPoint;
    }
    ...
    public String getAvgCorrFlashPoint() {
        return avgCorrFlashPoint;
    }

    public void setAvgCorrFlashPoint(String avgCorrFlashPoint) {
        this.avgCorrFlashPoint = avgCorrFlashPoint;
    }
    ...
    public String getAmbientBarometricPressure() {
        return ambientBarometricPressure;
    }

    public void setAmbientBarometricPressure(String ambientBarometricPressure) {
        this.ambientBarometricPressure = ambientBarometricPressure;
    }
