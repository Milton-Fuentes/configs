...
@Entity
@Immutable
@Table(name = "dot_ironstreel_sampleof", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotIronstreelSampleof.findAll", query = "SELECT a FROM DotIronstreelSampleof a")})
public class DotIronstreelSampleof implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "QTY_CHAR")
    private String qtyChar;
    @Size(max = 50)
    @Column(name = "TEST_METHOD_DESIGN")
    private String testMethodDesign;
    @Size(max = 50)
    ...
    public String getQtyChar() {
        return qtyChar;
    }

    public void setQtyChar(String qtyChar) {
        this.qtyChar = qtyChar;
    }

    public String getTestMethodDesign() {
        return testMethodDesign;
    }

    public void setTestMethodDesign(String testMethodDesign) {
        this.testMethodDesign = testMethodDesign;
    }
