...
@Entity
@Immutable
@Table(name = "dot_bend_t285", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotBendT285.findAll", query = "SELECT a FROM DotBendT285 a")})
public class DotBendT285 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "REBAR_SIZE_NO")
    private String rebarSizeNo;
    @Size(max = 50)
    @Column(name = "TEST_PROCEEDURE")
    private String testProceedure;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getRebarSizeNo() {
        return rebarSizeNo;
    }

    public void setRebarSizeNo(String rebarSizeNo) {
        this.rebarSizeNo = rebarSizeNo;
    }

    public String getTestProceedure() {
        return testProceedure;
    }

    public void setTestProceedure(String testProceedure) {
        this.testProceedure = testProceedure;
    }
