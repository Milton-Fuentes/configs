...
@Entity
@Immutable
@Table(name = "dot_pozzolan_sample", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotPozzolanSample.findAll", query = "SELECT a FROM DotPozzolanSample a")})
public class DotPozzolanSample implements Serializable {
