...
@Entity
@Immutable
@Table(name = "DOT_PFCA_T335", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotPfcaT335.findAll", query = "SELECT a FROM DotPfcaT335 a")})
public class DotPfcaT335 implements Serializable {
