...
@Entity
@Immutable
@Table(name = "dot_f075_t11", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotF075T11.findAll", query = "SELECT a FROM DotF075T11 a")})
public class DotF075T11 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "PCT_FINER")
    private String pctFiner;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "ORIGINAL_DRY_MASS")
    private String originalDryMass;
    @Size(max = 50)
    @Column(name = "DRY_MASS_AFTER_WASH")
    private String dryMassAfterWash;
    @Size(max = 50)
    @Column(name = "MASS_FINES_LOST_BY_WASHING")
    private String massFinesLostByWashing;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getPctFiner() {
        return pctFiner;
    }

    public void setPctFiner(String pctFiner) {
        this.pctFiner = pctFiner;
    }
    ...
    public String getOriginalDryMass() {
        return originalDryMass;
    }

    public void setOriginalDryMass(String originalDryMass) {
        this.originalDryMass = originalDryMass;
    }

    public String getDryMassAfterWash() {
        return dryMassAfterWash;
    }

    public void setDryMassAfterWash(String dryMassAfterWash) {
        this.dryMassAfterWash = dryMassAfterWash;
    }

    public String getMassFinesLostByWashing() {
        return massFinesLostByWashing;
    }

    public void setMassFinesLostByWashing(String massFinesLostByWashing) {
        this.massFinesLostByWashing = massFinesLostByWashing;
    }
