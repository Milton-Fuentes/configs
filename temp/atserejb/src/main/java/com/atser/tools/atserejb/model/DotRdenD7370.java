...
@Entity
@Immutable
@Table(name = "dot_rden_d7370", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotRdenD7370.findAll", query = "SELECT a FROM DotRdenD7370 a")})
public class DotRdenD7370 implements Serializable {
