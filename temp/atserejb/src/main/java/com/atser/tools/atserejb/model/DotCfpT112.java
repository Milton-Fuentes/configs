...
@Entity
@Immutable
@Table(name = "dot_cfp_t112", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotCfpT112.findAll", query = "SELECT a FROM DotCfpT112 a")})
public class DotCfpT112 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "TOTALBEFORE")
    private String totalbefore;
    @Size(max = 50)
    @Column(name = "TOTALAFTER")
    ...
    @Size(max = 50)
    @Column(name = "ORGSAMPPER")
    private String orgsampper;
    @Size(max = 50)
    @Column(name = "MINWT")
    private String minwt;
    @Size(max = 50)
    @Column(name = "DESIGNSIEVE")
    private String designsieve;
    @Size(max = 50)
    @Column(name = "WTBEFORE")
    private String wtbefore;
    @Size(max = 50)
    @Column(name = "WTAFTER")
    private String wtafter;
    @Size(max = 50)
    @Column(name = "PERCLAYFRIA")
    private String perclayfria;
    ...
    public void setAvgPercent(String avgPercent) {
    ...
    public String getOrgsampper() {
        return orgsampper;
    }

    public void setOrgsampper(String orgsampper) {
        this.orgsampper = orgsampper;
    }
    ...
    public String getDesignsieve() {
        return designsieve;
    }

    public void setDesignsieve(String designsieve) {
        this.designsieve = designsieve;
    }

    public String getWtbefore() {
        return wtbefore;
    }

    public void setWtbefore(String wtbefore) {
        this.wtbefore = wtbefore;
    }

    public String getWtafter() {
        return wtafter;
    }

    public void setWtafter(String wtafter) {
        this.wtafter = wtafter;
    }

    public String getPerclayfria() {
        return perclayfria;
    }

    public void setPerclayfria(String perclayfria) {
        this.perclayfria = perclayfria;
    }
