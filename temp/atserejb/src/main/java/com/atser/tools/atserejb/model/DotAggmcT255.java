...
@Entity
@Immutable
@Table(name = "dot_aggmc_t255", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAggmcT255.findAll", query = "SELECT a FROM DotAggmcT255 a")})
public class DotAggmcT255 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "MASS_ORIGINAL_SAMPLE")
    private String massOriginalSample;
    @Size(max = 50)
    @Column(name = "MASS_DRIED_SAMPLE")
    private String massDriedSample;
    @Size(max = 50)
    ...
    public String getMassOriginalSample() {
        return massOriginalSample;
    }

    public void setMassOriginalSample(String massOriginalSample) {
        this.massOriginalSample = massOriginalSample;
    }

    public String getMassDriedSample() {
        return massDriedSample;
    }

    public void setMassDriedSample(String massDriedSample) {
        this.massDriedSample = massDriedSample;
    }
