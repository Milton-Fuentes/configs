...
@Entity
@Immutable
@Table(name = "DOT_TEMP_T309", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotTempT309.findAll", query = "SELECT a FROM DotTempT309 a")})
public class DotTempT309 implements Serializable {
    ...
    @Column(name = "REQ_TEMP_SPEC_MIN")
    private Integer reqTempSpecMin;
    @Column(name = "REQ_TEMP_SPEC_MAX")
    private Integer reqTempSpecMax;
    ...
    public Integer getReqTempSpecMin() {
        return reqTempSpecMin;
    }

    public void setReqTempSpecMin(Integer reqTempSpecMin) {
        this.reqTempSpecMin = reqTempSpecMin;
    }

    public Integer getReqTempSpecMax() {
        return reqTempSpecMax;
    }

    public void setReqTempSpecMax(Integer reqTempSpecMax) {
        this.reqTempSpecMax = reqTempSpecMax;
    }
