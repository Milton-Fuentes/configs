...
@Entity
@Immutable
@Table(name = "dot_fnsoil_t27", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotFnsoilT27.findAll", query = "SELECT a FROM DotFnsoilT27 a")})
public class DotFnsoilT27 implements Serializable {
