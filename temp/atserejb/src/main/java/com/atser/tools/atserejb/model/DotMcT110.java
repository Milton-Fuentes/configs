...
@Entity
@Immutable
@Table(name = "DOT_MC_T110", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotMcT110.findAll", query = "SELECT a FROM DotMcT110 a")})
public class DotMcT110 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "VOLUME_WATER_RECIEVER")
    private String volumeWaterReciever;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "VOL_VOLUME_DILUENT_RECIEVER")
    private String volVolumeDiluentReciever;
    @Size(max = 50)
    @Column(name = "VOL_SPECIFIC_GRAVITY_DILUENT")
    private String volSpecificGravityDiluent;
    @Size(max = 50)
    @Column(name = "VOL_MASS_SAMPLE")
    private String volMassSample;
    @Size(max = 50)
    @Column(name = "VOL_PCT_MOISTURE")
    private String volPctMoisture;
    ...
    public String getVolumeWaterReciever() {
        return volumeWaterReciever;
    }

    public void setVolumeWaterReciever(String volumeWaterReciever) {
        this.volumeWaterReciever = volumeWaterReciever;
    }
    ...
    public String getVolVolumeDiluentReciever() {
        return volVolumeDiluentReciever;
    }

    public void setVolVolumeDiluentReciever(String volVolumeDiluentReciever) {
        this.volVolumeDiluentReciever = volVolumeDiluentReciever;
    }

    public String getVolSpecificGravityDiluent() {
        return volSpecificGravityDiluent;
    }

    public void setVolSpecificGravityDiluent(String volSpecificGravityDiluent) {
        this.volSpecificGravityDiluent = volSpecificGravityDiluent;
    }

    public String getVolMassSample() {
        return volMassSample;
    }

    public void setVolMassSample(String volMassSample) {
        this.volMassSample = volMassSample;
    }

    public String getVolPctMoisture() {
        return volPctMoisture;
    }

    public void setVolPctMoisture(String volPctMoisture) {
        this.volPctMoisture = volPctMoisture;
    }
