...
@Entity
@Immutable
@Table(name = "dot_tshc_t131", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotTshcT131.findAll", query = "SELECT a FROM DotTshcT131 a")})
public class DotTshcT131 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "VICAT_FINAL_TIME_SETTING")
    private String vicatFinalTimeSetting;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "TIME_FIRST_PENETRATION")
    private String timeFirstPenetration;
    @Size(max = 50)
    @Column(name = "TIME_LAST_PENETRATION")
    private String timeLastPenetration;
    @Size(max = 50)
    @Column(name = "PENET_FIRST_READING")
    private String penetFirstReading;
    @Size(max = 50)
    @Column(name = "PENET_LAST_READING")
    private String penetLastReading;
    @Size(max = 50)
    @Column(name = "VICAT_TIME_SETTING")
    private String vicatTimeSetting;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getVicatFinalTimeSetting() {
        return vicatFinalTimeSetting;
    }

    public void setVicatFinalTimeSetting(String vicatFinalTimeSetting) {
        this.vicatFinalTimeSetting = vicatFinalTimeSetting;
    }
    ...
    public String getTimeFirstPenetration() {
        return timeFirstPenetration;
    }

    public void setTimeFirstPenetration(String timeFirstPenetration) {
        this.timeFirstPenetration = timeFirstPenetration;
    }

    public String getTimeLastPenetration() {
        return timeLastPenetration;
    }

    public void setTimeLastPenetration(String timeLastPenetration) {
        this.timeLastPenetration = timeLastPenetration;
    }

    public String getPenetFirstReading() {
        return penetFirstReading;
    }

    public void setPenetFirstReading(String penetFirstReading) {
        this.penetFirstReading = penetFirstReading;
    }

    public String getPenetLastReading() {
        return penetLastReading;
    }

    public void setPenetLastReading(String penetLastReading) {
        this.penetLastReading = penetLastReading;
    }

    public String getVicatTimeSetting() {
        return vicatTimeSetting;
    }

    public void setVicatTimeSetting(String vicatTimeSetting) {
        this.vicatTimeSetting = vicatTimeSetting;
    }
