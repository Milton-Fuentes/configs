...
@Entity
@Immutable
@Table(name = "dot_proc_t180", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotProcT180.findAll", query = "SELECT a FROM DotProcT180 a")})
public class DotProcT180 implements Serializable {
