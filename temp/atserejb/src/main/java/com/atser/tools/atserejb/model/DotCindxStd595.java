...
@Entity
@Immutable
@Table(name = "dot_cindx_std595", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotCindxStd595.findAll", query = "SELECT a FROM DotCindxStd595 a")})
public class DotCindxStd595 implements Serializable {
