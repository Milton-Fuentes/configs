...
@Entity
@Immutable
@Table(name = "DOT_EMU_SAMPLE", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotEmuSample.findAll", query = "SELECT a FROM DotEmuSample a")})
public class DotEmuSample implements Serializable {
