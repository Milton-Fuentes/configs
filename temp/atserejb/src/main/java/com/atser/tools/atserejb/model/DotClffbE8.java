...
@Entity
@Immutable
@Table(name = "dot_clffb_e8", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotClffbE8.findAll", query = "SELECT a FROM DotClffbE8 a")})
public class DotClffbE8 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "DIAMETER_RESULT")
    private String diameterResult;
    @Size(max = 50)
    @Column(name = "TENSILE_BEFORE_FAB_RESULT")
    private String tensileBeforeFabResult;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "DIAMETER_SPEC_MIN")
    private String diameterSpecMin;
    @Size(max = 50)
    @Column(name = "DIAMETER_SPEC_MAX")
    private String diameterSpecMax;
    @Size(max = 50)
    @Column(name = "TENSILE_BEFORE_FAB_SPEC_MIN")
    private String tensileBeforeFabSpecMin;
    @Size(max = 50)
    @Column(name = "TENSILE_BEFORE_FAB_SPEC_MAX")
    private String tensileBeforeFabSpecMax;
    @Size(max = 50)
    @Column(name = "TENSILE_AFTER_FAB_SPEC_MIN")
    private String tensileAfterFabSpecMin;
    @Size(max = 50)
    @Column(name = "TENSILE_AFTER_FAB_SPEC_MAX")
    private String tensileAfterFabSpecMax;
    @Size(max = 4000)
    ...
    @Size(max = 50)
    @Column(name = "TENSILE_BEFORE_FAB")
    private String tensileBeforeFab;
    @Size(max = 50)
    @Column(name = "TENSILE_AFTER_FAB")
    private String tensileAfterFab;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getDiameterResult() {
        return diameterResult;
    }

    public void setDiameterResult(String diameterResult) {
        this.diameterResult = diameterResult;
    }

    public String getTensileBeforeFabResult() {
        return tensileBeforeFabResult;
    }

    public void setTensileBeforeFabResult(String tensileBeforeFabResult) {
        this.tensileBeforeFabResult = tensileBeforeFabResult;
    }
    ...
    public String getDiameterSpecMin() {
        return diameterSpecMin;
    }

    public void setDiameterSpecMin(String diameterSpecMin) {
        this.diameterSpecMin = diameterSpecMin;
    }

    public String getDiameterSpecMax() {
        return diameterSpecMax;
    }

    public void setDiameterSpecMax(String diameterSpecMax) {
        this.diameterSpecMax = diameterSpecMax;
    }

    public String getTensileBeforeFabSpecMin() {
        return tensileBeforeFabSpecMin;
    }

    public void setTensileBeforeFabSpecMin(String tensileBeforeFabSpecMin) {
        this.tensileBeforeFabSpecMin = tensileBeforeFabSpecMin;
    }

    public String getTensileBeforeFabSpecMax() {
        return tensileBeforeFabSpecMax;
    }

    public void setTensileBeforeFabSpecMax(String tensileBeforeFabSpecMax) {
        this.tensileBeforeFabSpecMax = tensileBeforeFabSpecMax;
    }

    public String getTensileAfterFabSpecMin() {
        return tensileAfterFabSpecMin;
    }

    public void setTensileAfterFabSpecMin(String tensileAfterFabSpecMin) {
        this.tensileAfterFabSpecMin = tensileAfterFabSpecMin;
    }

    public String getTensileAfterFabSpecMax() {
        return tensileAfterFabSpecMax;
    }

    public void setTensileAfterFabSpecMax(String tensileAfterFabSpecMax) {
        this.tensileAfterFabSpecMax = tensileAfterFabSpecMax;
    }
    ...
    public String getTensileBeforeFab() {
        return tensileBeforeFab;
    }

    public void setTensileBeforeFab(String tensileBeforeFab) {
        this.tensileBeforeFab = tensileBeforeFab;
    }

    public String getTensileAfterFab() {
        return tensileAfterFab;
    }

    public void setTensileAfterFab(String tensileAfterFab) {
        this.tensileAfterFab = tensileAfterFab;
    }
