...
@Entity
@Immutable
@Table(name = "DOT_RV_T316", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotRvT316.findAll", query = "SELECT a FROM DotRvT316 a")})
public class DotRvT316 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "ORIGINAL_VISCOSITY_135")
    private String originalViscosity135;
    @Size(max = 50)
    @Column(name = "ORIGINAL_VISCOSITY_165")
    private String originalViscosity165;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "AVG_ORIGINAL_VISCOSITY_135")
    private String avgOriginalViscosity135;
    @Size(max = 50)
    @Column(name = "AVG_ORIGINAL_VISCOSITY_165")
    private String avgOriginalViscosity165;
    @Size(max = 4000)
    @Column(name = "REMARKS")
    ...
    public String getOriginalViscosity135() {
        return originalViscosity135;
    }

    public void setOriginalViscosity135(String originalViscosity135) {
        this.originalViscosity135 = originalViscosity135;
    }

    public String getOriginalViscosity165() {
        return originalViscosity165;
    }

    public void setOriginalViscosity165(String originalViscosity165) {
        this.originalViscosity165 = originalViscosity165;
    }
    ...
    public String getAvgOriginalViscosity135() {
        return avgOriginalViscosity135;
    }

    public void setAvgOriginalViscosity135(String avgOriginalViscosity135) {
        this.avgOriginalViscosity135 = avgOriginalViscosity135;
    }

    public String getAvgOriginalViscosity165() {
        return avgOriginalViscosity165;
    }

    public void setAvgOriginalViscosity165(String avgOriginalViscosity165) {
        this.avgOriginalViscosity165 = avgOriginalViscosity165;
    }
