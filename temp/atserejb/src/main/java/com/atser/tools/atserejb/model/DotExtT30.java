...
@Entity
@Immutable
@Table(name = "DOT_EXT_T30", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotExtT30.findAll", query = "SELECT a FROM DotExtT30 a")})
public class DotExtT30 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "MASS_AGG_FROM_SCALE")
    private String massAggFromScale;
    @Size(max = 50)
    @Column(name = "MASS_AGG_AFTER_WASH")
    private String massAggAfterWash;
    @Size(max = 50)
    @Column(name = "MASS_FINES_FROM_WASH")
    private String massFinesFromWash;
    @Size(max = 50)
    @Column(name = "PAN")
    private String pan;
    @Size(max = 50)
    ...
    public String getMassAggFromScale() {
        return massAggFromScale;
    }

    public void setMassAggFromScale(String massAggFromScale) {
        this.massAggFromScale = massAggFromScale;
    }

    public String getMassAggAfterWash() {
        return massAggAfterWash;
    }

    public void setMassAggAfterWash(String massAggAfterWash) {
        this.massAggAfterWash = massAggAfterWash;
    }

    public String getMassFinesFromWash() {
        return massFinesFromWash;
    }

    public void setMassFinesFromWash(String massFinesFromWash) {
        this.massFinesFromWash = massFinesFromWash;
    }
