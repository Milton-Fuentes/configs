...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwQalabMaintLogV2.findAll", query = "SELECT a FROM VwQalabMaintLogV2 a")})
public class VwQalabMaintLogV2 implements Serializable {
