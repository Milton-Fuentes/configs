...
@Entity
@Immutable
@Table(name = "dot_fagg_t27", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotFaggT27.findAll", query = "SELECT a FROM DotFaggT27 a")})
public class DotFaggT27 implements Serializable {
