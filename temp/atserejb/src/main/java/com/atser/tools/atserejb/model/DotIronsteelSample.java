...
@Entity
@Immutable
@Table(name = "dot_ironsteel_sample", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotIronsteelSample.findAll", query = "SELECT a FROM DotIronsteelSample a")})
public class DotIronsteelSample implements Serializable {
