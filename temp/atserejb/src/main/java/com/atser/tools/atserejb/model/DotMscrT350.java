...
@Entity
@Immutable
@Table(name = "DOT_MSCR_T350", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotMscrT350.findAll", query = "SELECT a FROM DotMscrT350 a")})
public class DotMscrT350 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "AVG_PERCENT_RECOVERY_0_1")
    private String avgPercentRecovery01;
    @Size(max = 50)
    @Column(name = "AVG_NONCOVER_CREEP_COMPL_0_1")
    private String avgNoncoverCreepCompl01;
    @Size(max = 50)
    @Column(name = "AVG_PERCENT_RECOVERY_3_2")
    private String avgPercentRecovery32;
    @Size(max = 50)
    @Column(name = "AVG_NONCOVER_CREEP_COMPL_3_2")
    private String avgNoncoverCreepCompl32;
    @Size(max = 50)
    @Column(name = "PCT_DIFF")
   ...
   @JsonSerialize(using = JsonDateSerializer.class)
    ...
    public String getAvgPercentRecovery01() {
        return avgPercentRecovery01;
    }

    public void setAvgPercentRecovery01(String avgPercentRecovery01) {
        this.avgPercentRecovery01 = avgPercentRecovery01;
    }

    public String getAvgNoncoverCreepCompl01() {
        return avgNoncoverCreepCompl01;
    }

    public void setAvgNoncoverCreepCompl01(String avgNoncoverCreepCompl01) {
        this.avgNoncoverCreepCompl01 = avgNoncoverCreepCompl01;
    }

    public String getAvgPercentRecovery32() {
        return avgPercentRecovery32;
    }

    public void setAvgPercentRecovery32(String avgPercentRecovery32) {
        this.avgPercentRecovery32 = avgPercentRecovery32;
    }

    public String getAvgNoncoverCreepCompl32() {
        return avgNoncoverCreepCompl32;
    }

    public void setAvgNoncoverCreepCompl32(String avgNoncoverCreepCompl32) {
        this.avgNoncoverCreepCompl32 = avgNoncoverCreepCompl32;
    }

    public String getPctDiff() {
        return pctDiff;
    }

    public void setPctDiff(String pctDiff) {
    ...
    public String getPctDiff2() {
        return pctDiff2;
    }

    public void setPctDiff2(String pctDiff2) {
        this.pctDiff2 = pctDiff2;
    }
