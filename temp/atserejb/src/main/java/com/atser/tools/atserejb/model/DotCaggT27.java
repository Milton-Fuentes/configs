...
@Entity
@Immutable
@Table(name = "dot_cagg_t27", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotCaggT27.findAll", query = "SELECT a FROM DotCaggT27 a")})
public class DotCaggT27 implements Serializable {
