...
@Entity
@Immutable
@Table(name = "dot_aggla_t335", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAgglaT335.findAll", query = "SELECT a FROM DotAgglaT335 a")})
public class DotAgglaT335 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "MASS_UNFRACTURED_PARTICLES")
    private String massUnfracturedParticles;
    @Size(max = 50)
    @Column(name = "PCT_FRACTURE")
    private String pctFracture;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "AVG_PCT_FRACTURE")
    private String avgPctFracture;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "MASS_FRACTURED_PARTICLES")
    private String massFracturedParticles;
    @Size(max = 50)
    @Column(name = "MASS_QUESTIONABLE_PARTICLES")
    private String massQuestionableParticles;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getMassUnfracturedParticles() {
        return massUnfracturedParticles;
    }

    public void setMassUnfracturedParticles(String massUnfracturedParticles) {
        this.massUnfracturedParticles = massUnfracturedParticles;
    }

    public String getPctFracture() {
        return pctFracture;
    }

    public void setPctFracture(String pctFracture) {
        this.pctFracture = pctFracture;
    }
    ...
    public String getAvgPctFracture() {
        return avgPctFracture;
    }

    public void setAvgPctFracture(String avgPctFracture) {
        this.avgPctFracture = avgPctFracture;
    }
    ...
    public String getMassFracturedParticles() {
        return massFracturedParticles;
    }

    public void setMassFracturedParticles(String massFracturedParticles) {
        this.massFracturedParticles = massFracturedParticles;
    }

    public String getMassQuestionableParticles() {
        return massQuestionableParticles;
    }

    public void setMassQuestionableParticles(String massQuestionableParticles) {
        this.massQuestionableParticles = massQuestionableParticles;
    }
