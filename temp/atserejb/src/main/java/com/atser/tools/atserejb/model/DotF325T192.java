...
@Entity
@Immutable
@Table(name = "dot_f325_t192", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotF325T192.findAll", query = "SELECT a FROM DotF325T192 a")})
public class DotF325T192 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "SIEVE_CORRECTION_FACTOR")
    private String sieveCorrectionFactor;
    @Size(max = 50)
    @Column(name = "RESIDUE_SAMPLE_RETAINED")
    private String residueSampleRetained;
    @Size(max = 50)
    @Column(name = "CORRECTED_RESIDUE")
    private String correctedResidue;
    @Size(max = 50)
    @Column(name = "CEMENT_FINENESS")
    private String cementFineness;
    @Size(max = 50)
    @Column(name = "MASS_FLYASH")
    private String massFlyash;
    @Size(max = 50)
    ...
    public String getSieveCorrectionFactor() {
        return sieveCorrectionFactor;
    }

    public void setSieveCorrectionFactor(String sieveCorrectionFactor) {
        this.sieveCorrectionFactor = sieveCorrectionFactor;
    }

    public String getResidueSampleRetained() {
        return residueSampleRetained;
    }

    public void setResidueSampleRetained(String residueSampleRetained) {
        this.residueSampleRetained = residueSampleRetained;
    }

    public String getCorrectedResidue() {
        return correctedResidue;
    }

    public void setCorrectedResidue(String correctedResidue) {
        this.correctedResidue = correctedResidue;
    }
    ...
    public String getMassFlyash() {
        return massFlyash;
    }

    public void setMassFlyash(String massFlyash) {
        this.massFlyash = massFlyash;
    }
