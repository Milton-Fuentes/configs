...
@Entity
@Immutable
@Table(name = "DOT_AIRCONTENT_TP118", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAircontentTp118.findAll", query = "SELECT a FROM DotAircontentTp118 a")})
public class DotAircontentTp118 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "SUPER_AIR_METER_NO")
    ...
    @Size(max = 50)
    @Column(name = "SAM_NO_PSI")
    private String samNoPsi;
    @Size(max = 50)
    ...
    public String getSamNoPsi() {
        return samNoPsi;
    }

    public void setSamNoPsi(String samNoPsi) {
        this.samNoPsi = samNoPsi;
    }
