...
@Entity
@Immutable
@Table(name = "DOT_SOFTENING_T53", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotSofteningT53.findAll", query = "SELECT a FROM DotSofteningT53 a")})
public class DotSofteningT53 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "AVG_SOFTENING_POINT")
    private String avgSofteningPoint;
    @Size(max = 4000)
    @Column(name = "REMARKS")
    ...
    public String getAvgSofteningPoint() {
        return avgSofteningPoint;
    }

    public void setAvgSofteningPoint(String avgSofteningPoint) {
        this.avgSofteningPoint = avgSofteningPoint;
    }
