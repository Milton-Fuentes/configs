...
@Entity
@Immutable
@Table(name = "DOT_FRC_TP124", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotFrcTp124.findAll", query = "SELECT a FROM DotFrcTp124 a")})
public class DotFrcTp124 implements Serializable {
