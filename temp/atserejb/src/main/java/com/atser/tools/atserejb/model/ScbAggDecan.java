...
@Entity
@Immutable
@Table(name = "SCB_AGG_DECAN", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ScbAggDecan.findAll", query = "SELECT a FROM ScbAggDecan a")})
public class ScbAggDecan implements Serializable {
