...
@Entity
@Immutable
@Table(name = "DOT_PEN_T49", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotPenT49.findAll", query = "SELECT a FROM DotPenT49 a")})
public class DotPenT49 implements Serializable {
