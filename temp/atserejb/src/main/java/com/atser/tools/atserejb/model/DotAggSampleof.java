...
@Entity
@Immutable
@Table(name = "dot_agg_sampleof", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAggSampleof.findAll", query = "SELECT a FROM DotAggSampleof a")})
public class DotAggSampleof implements Serializable {
