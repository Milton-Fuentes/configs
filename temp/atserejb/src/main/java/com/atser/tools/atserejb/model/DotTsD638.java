...
@Entity
@Immutable
@Table(name = "dot_ts_d638", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotTsD638.findAll", query = "SELECT a FROM DotTsD638 a")})
public class DotTsD638 implements Serializable {
