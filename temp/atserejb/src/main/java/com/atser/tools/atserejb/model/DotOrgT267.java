...
@Entity
@Immutable
@Table(name = "dot_org_t267", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotOrgT267.findAll", query = "SELECT a FROM DotOrgT267 a")})
public class DotOrgT267 implements Serializable {
    ...
    @Size(max = 20)
    @Column(name = "IGNITION_END")
    private String ignitionEnd;
    @Size(max = 20)
    @Column(name = "IGNITION_TEMPERATURE")
    ...
    @Size(max = 50)
    @Column(name = "MASS_DISH_SOIL_BEFORE")
    private String massDishSoilBefore;
    @Size(max = 50)
    @Column(name = "MASS_DISH_SOIL_AFTER")
    private String massDishSoilAfter;
    @Size(max = 50)
    @Column(name = "MASS_DISH")
    private String massDish;
    @Size(max = 50)
    @Column(name = "PERCENT_ORGANIC_MATTER")
    private String percentOrganicMatter;
    @Size(max = 20)
    @Column(name = "IGNITION_START")
    private String ignitionStart;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getIgnitionEnd() {
        return ignitionEnd;
    }

    public void setIgnitionEnd(String ignitionEnd) {
        this.ignitionEnd = ignitionEnd;
    }
    ...
    public String getMassDishSoilBefore() {
        return massDishSoilBefore;
    }

    public void setMassDishSoilBefore(String massDishSoilBefore) {
        this.massDishSoilBefore = massDishSoilBefore;
    }

    public String getMassDishSoilAfter() {
        return massDishSoilAfter;
    }

    public void setMassDishSoilAfter(String massDishSoilAfter) {
        this.massDishSoilAfter = massDishSoilAfter;
    }
    ...
    public String getPercentOrganicMatter() {
        return percentOrganicMatter;
    }

    public void setPercentOrganicMatter(String percentOrganicMatter) {
        this.percentOrganicMatter = percentOrganicMatter;
    }

    public String getIgnitionStart() {
        return ignitionStart;
    }

    public void setIgnitionStart(String ignitionStart) {
        this.ignitionStart = ignitionStart;
    }
