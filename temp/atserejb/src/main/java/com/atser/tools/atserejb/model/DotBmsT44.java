...
@Entity
@Immutable
@Table(name = "DOT_BMS_T44", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotBmsT44.findAll", query = "SELECT a FROM DotBmsT44 a")})
public class DotBmsT44 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "SOLUBLE_PCT")
    ...
    @Size(max = 50)
    @Column(name = "AVG_INSOLUBLE_PCT")
    private String avgInsolublePct;
    @Size(max = 50)
    @Column(name = "AVG_SOLUBLE_PCT")
    private String avgSolublePct;
    @Size(max = 50)
    @Column(name = "SPEC_NO")
    private String specNo;
    @Size(max = 50)
    @Column(name = "MASS_CRUCIBLE_FILTER")
    private String massCrucibleFilter;
    @Size(max = 50)
    @Column(name = "TOTAL_MASS_SAMPLE")
    private String totalMassSample;
    @Size(max = 50)
    @Column(name = "MASS_CRUCIBLE_FILTER_INSOLUBLE")
    private String massCrucibleFilterInsoluble;
    @Size(max = 50)
    @Column(name = "INSOLUBLE_PCT")
