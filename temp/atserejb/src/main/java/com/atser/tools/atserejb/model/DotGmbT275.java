...
@Entity
@Immutable
@Table(name = "DOT_GMB_T275", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotGmbT275.findAll", query = "SELECT a FROM DotGmbT275 a")})
public class DotGmbT275 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "SPECIFIC_GRAVITY_WAX")
    private String specificGravityWax;
    @Size(max = 4000)
    ...
    @Size(max = 50)
    @Column(name = "MASS_SAMPLE_WAX_AIR")
    private String massSampleWaxAir;
    @Size(max = 50)
    @Column(name = "MASS_SAMPLE_WAX_WATER")
    private String massSampleWaxWater;
    @Size(max = 50)
    @Column(name = "VOLUME")
    ...
    public String getSpecificGravityWax() {
        return specificGravityWax;
    }

    public void setSpecificGravityWax(String specificGravityWax) {
        this.specificGravityWax = specificGravityWax;
    }
    ...
    public String getMassSampleWaxAir() {
        return massSampleWaxAir;
    }

    public void setMassSampleWaxAir(String massSampleWaxAir) {
        this.massSampleWaxAir = massSampleWaxAir;
    }

    public String getMassSampleWaxWater() {
        return massSampleWaxWater;
    }

    public void setMassSampleWaxWater(String massSampleWaxWater) {
        this.massSampleWaxWater = massSampleWaxWater;
    }
