...
@Entity
@Immutable
@Table(name = "dot_soft_t53", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotSoftT53.findAll", query = "SELECT a FROM DotSoftT53 a")})
public class DotSoftT53 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "TEMPERATURE_READING_1")
    private String temperatureReading1;
    @Size(max = 50)
    @Column(name = "TEMPERATURE_READING_2")
    private String temperatureReading2;
    @Size(max = 50)
    @Column(name = "SOFTENING_POINT")
    private String softeningPoint;
    @Size(max = 50)
    ...
    public String getTemperatureReading1() {
        return temperatureReading1;
    }

    public void setTemperatureReading1(String temperatureReading1) {
        this.temperatureReading1 = temperatureReading1;
    }

    public String getTemperatureReading2() {
        return temperatureReading2;
    }

    public void setTemperatureReading2(String temperatureReading2) {
        this.temperatureReading2 = temperatureReading2;
    }

    public String getSofteningPoint() {
        return softeningPoint;
    }

    public void setSofteningPoint(String softeningPoint) {
        this.softeningPoint = softeningPoint;
    }
