...
@Entity
@Immutable
@Table(name = "dot_svglass_d1214", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotSvglassD1214.findAll", query = "SELECT a FROM DotSvglassD1214 a")})
public class DotSvglassD1214 implements Serializable {
