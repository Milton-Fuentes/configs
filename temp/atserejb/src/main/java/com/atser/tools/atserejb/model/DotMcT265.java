...
@Entity
@Immutable
@Table(name = "dot_mc_t265", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotMcT265.findAll", query = "SELECT a FROM DotMcT265 a")})
public class DotMcT265 implements Serializable {
