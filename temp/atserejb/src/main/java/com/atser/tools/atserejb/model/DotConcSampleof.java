...
@Entity
@Immutable
@Table(name = "DOT_CONC_SAMPLEOF", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotConcSampleof.findAll", query = "SELECT a FROM DotConcSampleof a")})
public class DotConcSampleof implements Serializable {
