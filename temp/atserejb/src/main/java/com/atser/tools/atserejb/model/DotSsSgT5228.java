...
@Entity
@Immutable
@Table(name = "DOT_SS_SG_T5228", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotSsSgT5228.findAll", query = "SELECT a FROM DotSsSgT5228 a")})
public class DotSsSgT5228 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "MASS_PYCNOMETER_STOPPER")
    private String massPycnometerStopper;
    @Size(max = 50)
    @Column(name = "MASS_PYCNOMETER_FILLED_WATER")
    private String massPycnometerFilledWater;
    @Size(max = 50)
    @Column(name = "MASS_PYCNOMETER_PARTIAL_FILLED")
    private String massPycnometerPartialFilled;
    @Size(max = 50)
    @Column(name = "MASS_PYCNOMETER_ASPHALT_WATER")
    private String massPycnometerAsphaltWater;
    @Size(max = 50)
    @Column(name = "DENSITY_WATER_TEST_TEMPERATURE")
    private String densityWaterTestTemperature;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getMassPycnometerStopper() {
        return massPycnometerStopper;
    }

    public void setMassPycnometerStopper(String massPycnometerStopper) {
        this.massPycnometerStopper = massPycnometerStopper;
    }

    public String getMassPycnometerFilledWater() {
        return massPycnometerFilledWater;
    }

    public void setMassPycnometerFilledWater(String massPycnometerFilledWater) {
        this.massPycnometerFilledWater = massPycnometerFilledWater;
    }

    public String getMassPycnometerPartialFilled() {
        return massPycnometerPartialFilled;
    }

    public void setMassPycnometerPartialFilled(String massPycnometerPartialFilled) {
        this.massPycnometerPartialFilled = massPycnometerPartialFilled;
    }

    public String getMassPycnometerAsphaltWater() {
        return massPycnometerAsphaltWater;
    }

    public void setMassPycnometerAsphaltWater(String massPycnometerAsphaltWater) {
        this.massPycnometerAsphaltWater = massPycnometerAsphaltWater;
    }

    public String getDensityWaterTestTemperature() {
        return densityWaterTestTemperature;
    }

    public void setDensityWaterTestTemperature(String densityWaterTestTemperature) {
        this.densityWaterTestTemperature = densityWaterTestTemperature;
    }
