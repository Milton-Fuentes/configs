...
@Entity
@Immutable
@Table(name = "DOT_BINDER_SAMPLEOF", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotBinderSampleof.findAll", query = "SELECT a FROM DotBinderSampleof a")})
public class DotBinderSampleof implements Serializable {
