...
@Entity
@Immutable
@Table(name = "VW_QAASPM_MIXDJMF_EXP", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwQaaspmMixdjmfExp.findAll", query = "SELECT a FROM VwQaaspmMixdjmfExp a")})
public class VwQaaspmMixdjmfExp implements Serializable {
