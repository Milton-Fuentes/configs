...
@Entity
@Immutable
@Table(name = "dot_dft_d1005", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotDftD1005.findAll", query = "SELECT a FROM DotDftD1005 a")})
public class DotDftD1005 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "THICKNESS_READING_1")
    private String thicknessReading1;
    @Size(max = 50)
    @Column(name = "THICKNESS_READING_2")
    private String thicknessReading2;
    @Size(max = 50)
    @Column(name = "THICKNESS_READING_3")
    private String thicknessReading3;
    @Size(max = 50)
    @Column(name = "THICKNESS_READING_4")
    private String thicknessReading4;
    @Size(max = 50)
    @Column(name = "THICKNESS_READING_5")
    private String thicknessReading5;
    @Size(max = 50)
    ...
    public String getThicknessReading1() {
        return thicknessReading1;
    }

    public void setThicknessReading1(String thicknessReading1) {
        this.thicknessReading1 = thicknessReading1;
    }

    public String getThicknessReading2() {
        return thicknessReading2;
    }

    public void setThicknessReading2(String thicknessReading2) {
        this.thicknessReading2 = thicknessReading2;
    }

    public String getThicknessReading3() {
        return thicknessReading3;
    }

    public void setThicknessReading3(String thicknessReading3) {
        this.thicknessReading3 = thicknessReading3;
    }

    public String getThicknessReading4() {
        return thicknessReading4;
    }

    public void setThicknessReading4(String thicknessReading4) {
        this.thicknessReading4 = thicknessReading4;
    }

    public String getThicknessReading5() {
        return thicknessReading5;
    }

    public void setThicknessReading5(String thicknessReading5) {
        this.thicknessReading5 = thicknessReading5;
    }
