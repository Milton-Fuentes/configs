...
@Entity
@Immutable
@Table(name = "dot_ph_d4972", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotPhD4972.findAll", query = "SELECT a FROM DotPhD4972 a")})
public class DotPhD4972 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "SIZE_FRICTIONS_OTHER")
    private String sizeFrictionsOther;
    @Size(max = 4000)
    @Column(name = "REMARKS")
    ...
    @Size(max = 50)
    @Column(name = "PH_MEASUREMENTS")
    private String phMeasurements;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getSizeFrictionsOther() {
        return sizeFrictionsOther;
    }

    public void setSizeFrictionsOther(String sizeFrictionsOther) {
        this.sizeFrictionsOther = sizeFrictionsOther;
    }
    ...
    public String getPhMeasurements() {
        return phMeasurements;
    }

    public void setPhMeasurements(String phMeasurements) {
