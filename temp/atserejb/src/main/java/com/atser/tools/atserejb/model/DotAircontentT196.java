...
@Entity
@Immutable
@Table(name = "DOT_AIRCONTENT_T196", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAircontentT196.findAll", query = "SELECT a FROM DotAircontentT196 a")})
public class DotAircontentT196 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "ISOPROPYL_ALCOHOL_USED")
    private String isopropylAlcoholUsed;
    @Size(max = 50)
    @Column(name = "ADDED_WATER")
    ...
    public String getIsopropylAlcoholUsed() {
        return isopropylAlcoholUsed;
    }

    public void setIsopropylAlcoholUsed(String isopropylAlcoholUsed) {
        this.isopropylAlcoholUsed = isopropylAlcoholUsed;
    }
