...
@Entity
@Immutable
@Table(name = "dot_oimp_t21", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotOimpT21.findAll", query = "SELECT a FROM DotOimpT21 a")})
public class DotOimpT21 implements Serializable {
    ...
    @Size(max = 255)
    @Column(name = "ORG_PLATE_NO")
    private String orgPlateNo;
    @Size(max = 4000)
    @Column(name = "REMARKS")
    ...
    public String getOrgPlateNo() {
        return orgPlateNo;
    }

    public void setOrgPlateNo(String orgPlateNo) {
        this.orgPlateNo = orgPlateNo;
    }
