...
@Entity
@Immutable
@Table(name = "VW_QAASPM_MIXJMFSV", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwQaaspmMixJmfsv.findAll", query = "SELECT a FROM VwQaaspmMixJmfsv a")})
public class VwQaaspmMixJmfsv implements Serializable {
