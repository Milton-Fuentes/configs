...
@Entity
@Immutable
@Table(name = "dot_ccf_t65a90", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotCcfT65a90.findAll", query = "SELECT a FROM DotCcfT65a90 a")})
public class DotCcfT65a90 implements Serializable {
