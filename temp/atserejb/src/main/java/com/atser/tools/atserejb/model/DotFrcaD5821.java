...
@Entity
@Immutable
@Table(name = "dot_frca_d5821", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotFrcaD5821.findAll", query = "SELECT a FROM DotFrcaD5821 a")})
public class DotFrcaD5821 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "PCT_PARTICLES")
    private String pctParticles;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "USED_SIEVE_NO")
    private String usedSieveNo;
    @Size(max = 4000)
    ...
    @Size(max = 50)
    @Column(name = "WT_CRUSHED_PARTICLES")
    private String wtCrushedParticles;
    @Size(max = 50)
    @Column(name = "WT_UNCRUSHED_PARTICLES")
    private String wtUncrushedParticles;
    @Size(max = 50)
    @Column(name = "TOTAL_MASS_COARSE_AGG")
    private String totalMassCoarseAgg;

    public DotFrcaD5821() {
    }

    public String getPctParticles() {
        return pctParticles;
    }

    public void setPctParticles(String pctParticles) {
        this.pctParticles = pctParticles;
    }
    ...
    public String getUsedSieveNo() {
        return usedSieveNo;
    }

    public void setUsedSieveNo(String usedSieveNo) {
        this.usedSieveNo = usedSieveNo;
    }
    ...
    public String getWtCrushedParticles() {
        return wtCrushedParticles;
    }

    public void setWtCrushedParticles(String wtCrushedParticles) {
        this.wtCrushedParticles = wtCrushedParticles;
    }

    public String getWtUncrushedParticles() {
        return wtUncrushedParticles;
    }

    public void setWtUncrushedParticles(String wtUncrushedParticles) {
        this.wtUncrushedParticles = wtUncrushedParticles;
    }

    public String getTotalMassCoarseAgg() {
        return totalMassCoarseAgg;
    }

    public void setTotalMassCoarseAgg(String totalMassCoarseAgg) {
        this.totalMassCoarseAgg = totalMassCoarseAgg;
    }
