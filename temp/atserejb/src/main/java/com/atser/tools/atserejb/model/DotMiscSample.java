...
@Entity
@Immutable
@Table(name = "dot_misc_sample", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotMiscSample.findAll", query = "SELECT a FROM DotMiscSample a")})
public class DotMiscSample implements Serializable {
