...
@Entity
@Immutable
@Table(name = "dot_mas_c140", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotMasC140.findAll", query = "SELECT a FROM DotMasC140 a")})
public class DotMasC140 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "SPEC_MIN_STRENGTH")
    private String specMinStrength;
    @Size(max = 4000)
    ...
    @Size(max = 50)
    @Column(name = "AVG_ABS")
    private String avgAbs;
    @Size(max = 50)
    @Column(name = "SPEC_MAX_ABS")
    private String specMaxAbs;
    @Size(max = 50)
    @Column(name = "RESULT_ABS")
    private String resultAbs;
    @Size(max = 50)
    @Column(name = "AVG_STRENGTH")
    private String avgStrength;
    @Size(max = 50)
    @Column(name = "SPEC_MIN_STG")
    private String specMinStg;
    @Size(max = 50)
    @Column(name = "RESULT_STG")
    private String resultStg;
    @Size(max = 4000)
    ...
    @Size(max = 50)
    @Column(name = "SPEC_MAX_ABSORPTION")
    private String specMaxAbsorption;
    @Size(max = 50)
    @Column(name = "RESULT_ABSORPTION")
    private String resultAbsorption;
    @Size(max = 50)
    @Column(name = "LENGTH")
    ...
    @Size(max = 50)
    @Column(name = "RESULT_STRENGTH")
    private String resultStrength;
    ...
    public String getSpecMinStrength() {
        return specMinStrength;
    }

    public void setSpecMinStrength(String specMinStrength) {
        this.specMinStrength = specMinStrength;
    }
    ...
    public String getAvgAbs() {
        return avgAbs;
    }

    public void setAvgAbs(String avgAbs) {
        this.avgAbs = avgAbs;
    }

    public String getSpecMaxAbs() {
        return specMaxAbs;
    }

    public void setSpecMaxAbs(String specMaxAbs) {
        this.specMaxAbs = specMaxAbs;
    }
    ...
    public String getSpecMinStg() {
        return specMinStg;
    }

    public void setSpecMinStg(String specMinStg) {
        this.specMinStg = specMinStg;
    }

    public String getResultStg() {
        return resultStg;
    }

    public void setResultStg(String resultStg) {
        this.resultStg = resultStg;
    }
    ...
    public String getSpecMaxAbsorption() {
        return specMaxAbsorption;
    }

    public void setSpecMaxAbsorption(String specMaxAbsorption) {
        this.specMaxAbsorption = specMaxAbsorption;
    }

    public String getResultAbsorption() {
        return resultAbsorption;
    }

    public void setResultAbsorption(String resultAbsorption) {
        this.resultAbsorption = resultAbsorption;
    }
    ...
    public String getResultStrength() {
        return resultStrength;
    }

    public void setResultStrength(String resultStrength) {
        this.resultStrength = resultStrength;
    }
