...
@Entity
@Immutable
@Table(name = "dot_vid_d2488", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotVidD2488.findAll", query = "SELECT a FROM DotVidD2488 a")})
public class DotVidD2488 implements Serializable {
