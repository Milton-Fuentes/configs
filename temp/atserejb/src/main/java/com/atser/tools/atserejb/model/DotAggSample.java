...
@Entity
@Immutable
@Table(name = "DOT_AGG_SAMPLE", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAggSample.findAll", query = "SELECT a FROM DotAggSample a")})
public class DotAggSample implements Serializable {
