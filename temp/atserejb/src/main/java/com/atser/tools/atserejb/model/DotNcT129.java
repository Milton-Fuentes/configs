...
@Entity
@Immutable
@Table(name = "dot_nc_t129", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotNcT129.findAll", query = "SELECT a FROM DotNcT129 a")})
public class DotNcT129 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "SETTLING_SPEC_MIN")
    private String settlingSpecMin;
    @Size(max = 50)
    @Column(name = "SETTLING_SPEC_MAX")
    private String settlingSpecMax;
    @Size(max = 50)
    @Column(name = "SPECIMEN_NO")
    private String specimenNo;
    @Size(max = 50)
    @Column(name = "MASS_OF_WATER")
    private String massOfWater;
    @Size(max = 50)
    @Column(name = "MASS_OF_CEMENT")
    private String massOfCement;
    @Size(max = 50)
    @Column(name = "AMOUNT_OF_WATER")
    private String amountOfWater;
    @Size(max = 50)
    @Column(name = "SETTLING_ROD_NORMAL")
    private String settlingRodNormal;
    @Size(max = 50)
    @Column(name = "SETTLING_RESULT")
    private String settlingResult;
    @Size(max = 50)
    ...
    public String getSettlingSpecMin() {
        return settlingSpecMin;
    }

    public void setSettlingSpecMin(String settlingSpecMin) {
        this.settlingSpecMin = settlingSpecMin;
    }

    public String getSettlingSpecMax() {
        return settlingSpecMax;
    }

    public void setSettlingSpecMax(String settlingSpecMax) {
        this.settlingSpecMax = settlingSpecMax;
    }
    ...
    public void setMassOfWater(String massOfWater) {
        this.massOfWater = massOfWater;
    }

    public String getMassOfCement() {
        return massOfCement;
    }

    public void setMassOfCement(String massOfCement) {
        this.massOfCement = massOfCement;
    }
    ...
    public String getSettlingRodNormal() {
        return settlingRodNormal;
    }

    public void setSettlingRodNormal(String settlingRodNormal) {
        this.settlingRodNormal = settlingRodNormal;
    }

    public String getSettlingResult() {
        return settlingResult;
    }

    public void setSettlingResult(String settlingResult) {
        this.settlingResult = settlingResult;
    }
