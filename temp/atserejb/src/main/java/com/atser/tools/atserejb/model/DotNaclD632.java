...
@Entity
@Immutable
@Table(name = "dot_nacl_d632", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotNaclD632.findAll", query = "SELECT a FROM DotNaclD632 a")})
public class DotNaclD632 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "REAGENT_GRADE_NACL")
    private String reagentGradeNacl;
    @Size(max = 50)
    @Column(name = "SOLUTION_REAGENT_GRADE_NACL")
    private String solutionReagentGradeNacl;
    @Size(max = 50)
    @Column(name = "SOLUTION_SAMPLE_BEING_TESTED")
    private String solutionSampleBeingTested;
    @Size(max = 50)
    @Column(name = "TEST_SAMPLING_MASS")
    private String testSamplingMass;
    @Size(max = 50)
    @Column(name = "PERCENT_CHLORIDE")
    private String percentChloride;
    @Size(max = 50)
    ...
    public String getReagentGradeNacl() {
        return reagentGradeNacl;
    }

    public void setReagentGradeNacl(String reagentGradeNacl) {
        this.reagentGradeNacl = reagentGradeNacl;
    }

    public String getSolutionReagentGradeNacl() {
        return solutionReagentGradeNacl;
    }

    public void setSolutionReagentGradeNacl(String solutionReagentGradeNacl) {
        this.solutionReagentGradeNacl = solutionReagentGradeNacl;
    }

    public String getSolutionSampleBeingTested() {
        return solutionSampleBeingTested;
    }

    public void setSolutionSampleBeingTested(String solutionSampleBeingTested) {
        this.solutionSampleBeingTested = solutionSampleBeingTested;
    }

    public String getTestSamplingMass() {
        return testSamplingMass;
    }

    public void setTestSamplingMass(String testSamplingMass) {
        this.testSamplingMass = testSamplingMass;
    }

    public String getPercentChloride() {
        return percentChloride;
    }

    public void setPercentChloride(String percentChloride) {
        this.percentChloride = percentChloride;
    }
