...
@Entity
@Immutable
@Table(name = "dot_aggse_t176", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAggseT176.findAll", query = "SELECT a FROM DotAggseT176 a")})
public class DotAggseT176 implements Serializable {
