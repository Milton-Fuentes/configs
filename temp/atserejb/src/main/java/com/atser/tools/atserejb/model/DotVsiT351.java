...
@Entity
@Immutable
@Table(name = "DOT_VSI_T351", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotVsiT351.findAll", query = "SELECT a FROM DotVsiT351 a")})
public class DotVsiT351 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "VISUAL_STABILITY_INDEX")
    private String visualStabilityIndex;
    @Size(max = 50)
    @Column(name = "TECH_ID")
    ...
    public String getVisualStabilityIndex() {
        return visualStabilityIndex;
    }

    public void setVisualStabilityIndex(String visualStabilityIndex) {
        this.visualStabilityIndex = visualStabilityIndex;
    }
