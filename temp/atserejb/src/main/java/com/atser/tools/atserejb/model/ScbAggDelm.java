...
@Entity
@Immutable
@Table(name = "SCB_AGG_DELM", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ScbAggDelm.findAll", query = "SELECT a FROM ScbAggDelm a")})
public class ScbAggDelm implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "DELETERIOUS")
    private String deleterious;
    @Size(max = 4000)
    @Column(name = "REMARKS")
    ...
    public String getDeleterious() {
        return deleterious;
    }

    public void setDeleterious(String deleterious) {
        this.deleterious = deleterious;
    }
