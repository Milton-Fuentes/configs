...
@Entity
@Immutable
@Table(name = "dot_gsz_t311", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotGszT311.findAll", query = "SELECT a FROM DotGszT311 a")})
public class DotGszT311 implements Serializable {
