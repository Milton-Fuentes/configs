...
@Entity
@Immutable
@Table(name = "DOT_ABR_TP108", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotAbrTp108.findAll", query = "SELECT a FROM DotAbrTp108 a")})
public class DotAbrTp108 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "INITIAL_SPECIMEN_MASS")
    private String initialSpecimenMass;
    @Size(max = 50)
    @Column(name = "FINAL_SPECIMEN_MASS")
    private String finalSpecimenMass;
    @Size(max = 50)
    @Column(name = "PCT_ABRASION_LOSS")
    private String pctAbrasionLoss;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "AVG_PCT_ABRASION_LOSS")
    private String avgPctAbrasionLoss;
    @Size(max = 50)
    ...
    public String getInitialSpecimenMass() {
        return initialSpecimenMass;
    }

    public void setInitialSpecimenMass(String initialSpecimenMass) {
        this.initialSpecimenMass = initialSpecimenMass;
    }

    public String getFinalSpecimenMass() {
        return finalSpecimenMass;
    }

    public void setFinalSpecimenMass(String finalSpecimenMass) {
        this.finalSpecimenMass = finalSpecimenMass;
    }

    public String getPctAbrasionLoss() {
        return pctAbrasionLoss;
    }

    public void setPctAbrasionLoss(String pctAbrasionLoss) {
        this.pctAbrasionLoss = pctAbrasionLoss;
    }
    ...
    public String getAvgPctAbrasionLoss() {
        return avgPctAbrasionLoss;
    }

    public void setAvgPctAbrasionLoss(String avgPctAbrasionLoss) {
        this.avgPctAbrasionLoss = avgPctAbrasionLoss;
    }
