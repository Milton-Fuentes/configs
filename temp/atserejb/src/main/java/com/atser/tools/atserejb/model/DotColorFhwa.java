...
@Entity
@Immutable
@Table(name = "dot_color_fhwa", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotColorFhwa.findAll", query = "SELECT a FROM DotColorFhwa a")})
public class DotColorFhwa implements Serializable {
