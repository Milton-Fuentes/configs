...
@Entity
@Immutable
@Table(name = "DOT_EMU_SAMPLEOF", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotEmuSampleof.findAll", query = "SELECT a FROM DotEmuSampleof a")})
public class DotEmuSampleof implements Serializable {
