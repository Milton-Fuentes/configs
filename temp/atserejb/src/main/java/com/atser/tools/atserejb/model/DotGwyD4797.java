...
@Entity
@Immutable
@Table(name = "dot_gwy_d4797", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotGwyD4797.findAll", query = "SELECT a FROM DotGwyD4797 a")})
public class DotGwyD4797 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "WEIGHT_CRUCIBLE_SAMPLE")
    private String weightCrucibleSample;
    @Size(max = 50)
    @Column(name = "WEIGHT_CRUCIBLE")
    private String weightCrucible;
    @Size(max = 50)
    @Column(name = "WEIGHT_SAMPLE")
    private String weightSample;
    @Size(max = 50)
    @Column(name = "WEIGHT_CRUCIBLE_ASH")
    private String weightCrucibleAsh;
    @Size(max = 50)
    @Column(name = "WEIGHT_CRUCIBLE2")
    private String weightCrucible2;
    @Size(max = 50)
    @Column(name = "WEIGHT_ASH")
    private String weightAsh;
    @Size(max = 50)
    @Column(name = "PCT_BINDER")
    private String pctBinder;
    @Size(max = 50)
    ...
    public String getWeightCrucibleSample() {
        return weightCrucibleSample;
    }

    public void setWeightCrucibleSample(String weightCrucibleSample) {
        this.weightCrucibleSample = weightCrucibleSample;
    }

    public String getWeightCrucible() {
        return weightCrucible;
    }

    public void setWeightCrucible(String weightCrucible) {
        this.weightCrucible = weightCrucible;
    }
    ...
    public void setWeightSample(String weightSample) {
        this.weightSample = weightSample;
    }

    public String getWeightCrucibleAsh() {
        return weightCrucibleAsh;
    }

    public void setWeightCrucibleAsh(String weightCrucibleAsh) {
        this.weightCrucibleAsh = weightCrucibleAsh;
    }

    public String getWeightCrucible2() {
        return weightCrucible2;
    }

    public void setWeightCrucible2(String weightCrucible2) {
        this.weightCrucible2 = weightCrucible2;
    }

    public String getWeightAsh() {
        return weightAsh;
    }

    public void setWeightAsh(String weightAsh) {
        this.weightAsh = weightAsh;
    }

    public String getPctBinder() {
        return pctBinder;
    }

    public void setPctBinder(String pctBinder) {
        this.pctBinder = pctBinder;
    }
