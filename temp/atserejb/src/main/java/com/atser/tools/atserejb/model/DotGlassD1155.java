...
@Entity
@Immutable
@Table(name = "dot_glass_d1155", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotGlassD1155.findAll", query = "SELECT a FROM DotGlassD1155 a")})
public class DotGlassD1155 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "TOTAL_PCT_ROUNDNESS")
    private String totalPctRoundness;
    @Size(max = 50)
    ...
    public String getTotalPctRoundness() {
        return totalPctRoundness;
    }

    public void setTotalPctRoundness(String totalPctRoundness) {
        this.totalPctRoundness = totalPctRoundness;
    }
