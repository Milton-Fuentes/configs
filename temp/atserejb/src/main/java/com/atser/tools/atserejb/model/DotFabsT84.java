...
@Entity
@Immutable
@Table(name = "dot_fabs_t84", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotFabsT84.findAll", query = "SELECT a FROM DotFabsT84 a")})
public class DotFabsT84 implements Serializable {
