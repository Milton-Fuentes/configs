...
@Entity
@Immutable
@Table(name = "dot_pozzolan_sampleof", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotPozzolanSampleof.findAll", query = "SELECT a FROM DotPozzolanSampleof a")})
public class DotPozzolanSampleof implements Serializable {
