...
@Entity
@Immutable
@Table(name = "dot_casoil_t27", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotCasoilT27.findAll", query = "SELECT a FROM DotCasoilT27 a")})
public class DotCasoilT27 implements Serializable {
