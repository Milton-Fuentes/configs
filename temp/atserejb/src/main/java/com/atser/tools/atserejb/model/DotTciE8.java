...
@Entity
@Immutable
@Table(name = "dot_tci_e8", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotTciE8.findAll", query = "SELECT a FROM DotTciE8 a")})
public class DotTciE8 implements Serializable {
