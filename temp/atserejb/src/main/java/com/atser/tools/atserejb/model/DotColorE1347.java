...
@Entity
@Immutable
@Table(name = "dot_color_e1347", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotColorE1347.findAll", query = "SELECT a FROM DotColorE1347 a")})
public class DotColorE1347 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "READING_1")
    private String reading1;
    @Size(max = 50)
    @Column(name = "READING_2")
    private String reading2;
    @Size(max = 50)
    @Column(name = "READING_3")
    private String reading3;
    @Size(max = 50)
    @Column(name = "READING_4")
    private String reading4;
    @Size(max = 50)
    @Column(name = "READING_5")
    ...
    public void setReading5(String reading5) {
