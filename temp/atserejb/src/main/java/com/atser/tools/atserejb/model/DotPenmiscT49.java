...
@Entity
@Immutable
@Table(name = "dot_penmisc_t49", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotPenmiscT49.findAll", query = "SELECT a FROM DotPenmiscT49 a")})
public class DotPenmiscT49 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "CONTAINER_DIAMETER")
    private String containerDiameter;
    @Size(max = 50)
    @Column(name = "CONTAINER_DEPTH")
    private String containerDepth;
    @Size(max = 50)
    @Column(name = "AVG_PENETRATION")
    private String avgPenetration;
    @Size(max = 4000)
    ...
    public String getContainerDiameter() {
        return containerDiameter;
    }

    public void setContainerDiameter(String containerDiameter) {
        this.containerDiameter = containerDiameter;
    }

    public String getContainerDepth() {
        return containerDepth;
    }

    public void setContainerDepth(String containerDepth) {
