...
@Entity
@Immutable
@Table(name = "dot_ctw_t65a90", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotCtwT65a90.findAll", query = "SELECT a FROM DotCtwT65a90 a")})
public class DotCtwT65a90 implements Serializable {
