...
@Entity
@Immutable
@Table(name = "dot_cadg_t327", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotCadgT327.findAll", query = "SELECT a FROM DotCadgT327 a")})
public class DotCadgT327 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 3)
    @Column(name = "MASS_3")
    private String mass3;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "TOTAL_NO_REVOLUTIONS")
    private String totalNoRevolutions;
    @Size(max = 50)
    @Column(name = "AVERAGE_RPM")
    private String averageRpm;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "OVEN_DRIED_SAMPLE")
    private String ovenDriedSample;
    @Size(max = 50)
    @Column(name = "TOTAL_MASS_AGGREGATE")
    private String totalMassAggregate;
    @Size(max = 50)
    @Column(name = "MASS_PROPORTIONS")
    private String massProportions;
    @Size(max = 50)
    @Column(name = "NUMBER_REVOLUTIONS")
    private String numberRevolutions;
    @Size(max = 50)
    ...
    public void setMass3(String mass3) {
        this.mass3 = mass3;
    }
    ...
    public String getTotalNoRevolutions() {
        return totalNoRevolutions;
    }

    public void setTotalNoRevolutions(String totalNoRevolutions) {
        this.totalNoRevolutions = totalNoRevolutions;
    }
    ...
    public String getOvenDriedSample() {
        return ovenDriedSample;
    }

    public void setOvenDriedSample(String ovenDriedSample) {
        this.ovenDriedSample = ovenDriedSample;
    }

    public String getTotalMassAggregate() {
        return totalMassAggregate;
    }

    public void setTotalMassAggregate(String totalMassAggregate) {
        this.totalMassAggregate = totalMassAggregate;
    }

    public String getMassProportions() {
        return massProportions;
    }

    public void setMassProportions(String massProportions) {
        this.massProportions = massProportions;
    }

    public String getNumberRevolutions() {
        return numberRevolutions;
    }

    public void setNumberRevolutions(String numberRevolutions) {
        this.numberRevolutions = numberRevolutions;
    }
    ...
    public String getMprop() {
        return mprop;
    }

    public void setMprop(String mprop) {
        this.mprop = mprop;
    }
    ...
    public Character getMass1() {
        return mass1;
    }

    public void setMass1(Character mass1) {
        this.mass1 = mass1;
    }
    ...
    public Character getMass2() {
        return mass2;
    }

    public void setMass2(Character mass2) {
        this.mass2 = mass2;
    }
