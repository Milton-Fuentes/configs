...
@Entity
@Immutable
@Table(name = "dot_misc_sampleof", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotMiscSampleof.findAll", query = "SELECT a FROM DotMiscSampleof a")})
public class DotMiscSampleof implements Serializable {
