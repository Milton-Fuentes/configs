...
@Entity
@Immutable
@Table(name = "DOT_HMA_SAMPLEOF", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotHmaSampleof.findAll", query = "SELECT a FROM DotHmaSampleof a")})
public class DotHmaSampleof implements Serializable {
