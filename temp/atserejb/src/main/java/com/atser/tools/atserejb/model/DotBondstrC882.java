...
@Entity
@Immutable
@Table(name = "DOT_BONDSTR_C882", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotBondstrC882.findAll", query = "SELECT a FROM DotBondstrC882 a")})
public class DotBondstrC882 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "AVG7DAYS")
    private String avg7days;
    @Size(max = 50)
    @Column(name = "AVG28DAYS")
    ...
    @Size(max = 50)
    @Column(name = "NO_VOIDS")
    private String noVoids;
    @Size(max = 50)
    @Column(name = "AREA_VOIDS")
    private String areaVoids;
    @Size(max = 50)
    @Column(name = "BONDING_AREA")
    private String bondingArea;
    @Size(max = 50)
    @Column(name = "LOAD")
    private String load;
    @Size(max = 50)
    @Column(name = "BONDINGSTRENGTH")
    private String bondingstrength;
    @Size(max = 50)
    ...
    public String getAreaVoids() {
        return areaVoids;
    }

    public void setAreaVoids(String areaVoids) {
        this.areaVoids = areaVoids;
    }

    public String getBondingArea() {
        return bondingArea;
    }

    public void setBondingArea(String bondingArea) {
    ...
    public String getBondingstrength() {
        return bondingstrength;
    }

    public void setBondingstrength(String bondingstrength) {
