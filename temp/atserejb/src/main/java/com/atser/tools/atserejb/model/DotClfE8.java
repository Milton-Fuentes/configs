...
@Entity
@Immutable
@Table(name = "dot_clf_e8", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotClfE8.findAll", query = "SELECT a FROM DotClfE8 a")})
public class DotClfE8 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "LOAD_SPEC_MIN")
    private String loadSpecMin;
    @Size(max = 50)
    @Column(name = "LOAD_SPEC_MAX")
    private String loadSpecMax;
    @Size(max = 4000)
    ...
    public String getLoadSpecMin() {
        return loadSpecMin;
    }

    public void setLoadSpecMin(String loadSpecMin) {
        this.loadSpecMin = loadSpecMin;
    }

    public String getLoadSpecMax() {
        return loadSpecMax;
    }

    public void setLoadSpecMax(String loadSpecMax) {
        this.loadSpecMax = loadSpecMax;
    }
