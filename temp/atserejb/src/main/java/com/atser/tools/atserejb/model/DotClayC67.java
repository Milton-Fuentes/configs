...
@Entity
@Immutable
@Table(name = "dot_clay_c67", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotClayC67.findAll", query = "SELECT a FROM DotClayC67 a")})
public class DotClayC67 implements Serializable {
