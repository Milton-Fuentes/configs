...
@Entity
@Immutable
@Table(name = "dot_pcw_d3723", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotPcwD3723.findAll", query = "SELECT a FROM DotPcwD3723 a")})
public class DotPcwD3723 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "WEIGHT_DISH_AND_SPECIMEN")
    private String weightDishAndSpecimen;
    @Size(max = 50)
    @Column(name = "WEIGHT_DISH_ALONE")
    private String weightDishAlone;
    @Size(max = 50)
    @Column(name = "SPECIMEN_WEIGHT")
    private String specimenWeight;
    @Size(max = 50)
    @Column(name = "PCT_PIGMENT")
    private String pctPigment;
    @Size(max = 50)
    ...
    public String getWeightDishAndSpecimen() {
        return weightDishAndSpecimen;
    }

    public void setWeightDishAndSpecimen(String weightDishAndSpecimen) {
        this.weightDishAndSpecimen = weightDishAndSpecimen;
    }

    public String getWeightDishAlone() {
        return weightDishAlone;
    }

    public void setWeightDishAlone(String weightDishAlone) {
        this.weightDishAlone = weightDishAlone;
    }
    ...
    public String getPctPigment() {
        return pctPigment;
    }

    public void setPctPigment(String pctPigment) {
        this.pctPigment = pctPigment;
    }
