...
@Entity
@Immutable
@Table(name = "dot_soil_sample", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotSoilSample.findAll", query = "SELECT a FROM DotSoilSample a")})
public class DotSoilSample implements Serializable {
    ...
    public Character getEquipList() {
        return equipList;
    }

    public void setEquipList(Character equipList) {
    ...
    public String getSamplenoLinkFix() {
