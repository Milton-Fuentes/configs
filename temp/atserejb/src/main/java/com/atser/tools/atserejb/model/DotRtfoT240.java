...
@Entity
@Immutable
@Table(name = "DOT_RTFO_T240", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotRtfoT240.findAll", query = "SELECT a FROM DotRtfoT240 a")})
public class DotRtfoT240 implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "WEIGHT_AFTER_RTFO")
    private String weightAfterRtfo;
    @Size(max = 50)
    @Column(name = "PCT_DIFFERENCE")
    private String pctDifference;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "WEIGHT_OF_EMPTY_BOTTLE")
    private String weightOfEmptyBottle;
    @Id
    @NotNull
    @Column(name = "ID")
    ...
    public String getWeightAfterRtfo() {
        return weightAfterRtfo;
    }

    public void setWeightAfterRtfo(String weightAfterRtfo) {
        this.weightAfterRtfo = weightAfterRtfo;
    }

    public String getPctDifference() {
        return pctDifference;
    }

    public void setPctDifference(String pctDifference) {
        this.pctDifference = pctDifference;
    }
   ...
   @JsonSerialize(using = JsonDateSerializer.class)
    ...
    public String getMassChange() {
        return massChange;
    }

    public void setMassChange(String massChange) {
    ...
    public String getWeightOfEmptyBottle() {
        return weightOfEmptyBottle;
    }

    public void setWeightOfEmptyBottle(String weightOfEmptyBottle) {
        this.weightOfEmptyBottle = weightOfEmptyBottle;
    }
