...
@Entity
@Immutable
@Table(name = "dot_sgt_d792", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotSgtD792.findAll", query = "SELECT a FROM DotSgtD792 a")})
public class DotSgtD792 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "WEIGHT_SPECIMEN_LIQUID")
    private String weightSpecimenLiquid;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "WEIGHT_SPECIMEN_AIR")
    private String weightSpecimenAir;

    public DotSgtD792() {
    }

    public String getWeightSpecimenLiquid() {
        return weightSpecimenLiquid;
    }

    public void setWeightSpecimenLiquid(String weightSpecimenLiquid) {
        this.weightSpecimenLiquid = weightSpecimenLiquid;
    }
    ...
    public String getWeightSpecimenAir() {
        return weightSpecimenAir;
    }

    public void setWeightSpecimenAir(String weightSpecimenAir) {
        this.weightSpecimenAir = weightSpecimenAir;
    }
