...
@Entity
@Immutable
@Table(name = "dot_soil_sampleof", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotSoilSampleof.findAll", query = "SELECT a FROM DotSoilSampleof a")})
public class DotSoilSampleof implements Serializable {
