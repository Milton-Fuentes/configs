...
@Entity
@Immutable
@Table(name = "DOT_MC_T329", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotMcT329.findAll", query = "SELECT a FROM DotMcT329 a")})
public class DotMcT329 implements Serializable {
