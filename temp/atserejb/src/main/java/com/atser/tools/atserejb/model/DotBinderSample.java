...
@Entity
@Immutable
@Table(name = "DOT_BINDER_SAMPLE", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotBinderSample.findAll", query = "SELECT a FROM DotBinderSample a")})
public class DotBinderSample implements Serializable {
