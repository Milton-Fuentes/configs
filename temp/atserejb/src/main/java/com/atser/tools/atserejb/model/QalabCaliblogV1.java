...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "QalabCaliblogV1.findAll", query = "SELECT q FROM QalabCaliblogV1 q")
    , @NamedQuery(name = "QalabCaliblogV1.findById", query = "SELECT q FROM QalabCaliblogV1 q WHERE q.id = :id")})
public class QalabCaliblogV1 implements Serializable {
    ...
    private QalabEquipinfoV1 labEquipId;
    ...
    public QalabCaliblogV1() {
    }

    public QalabCaliblogV1(BigDecimal id) {
        this.id = id;
    }
    ...
    public QalabEquipinfoV1 getLabEquipId() {
        return labEquipId;
    }

    public void setLabEquipId(QalabEquipinfoV1 labEquipId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QalabCaliblogV1)) {
            return false;
        }
        QalabCaliblogV1 other = (QalabCaliblogV1) object;
    ...
    public String toString() {
        return "com.atser.tools.atserejb.model.QalabCaliblogV1[ id=" + id + " ]";
    }
}
