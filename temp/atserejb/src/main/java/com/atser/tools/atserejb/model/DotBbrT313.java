...
@Entity
@Immutable
@Table(name = "DOT_BBR_T313", catalog = "", schema = "ORACLE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DotBbrT313.findAll", query = "SELECT a FROM DotBbrT313 a")})
public class DotBbrT313 implements Serializable {

    private static final long serialVersionUID = 1L;
    @Size(max = 50)
    @Column(name = "LOW_GRADE_TEMPERATURE")
    private String lowGradeTemperature;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "AVG_CREEP_STIFFNESS")
    private String avgCreepStiffness;
    @Size(max = 50)
    @Column(name = "AVG_M_VALUE")
    private String avgMValue;
    @Size(max = 50)
    @Column(name = "AVG_TEST_TEMPERATURE")
    private String avgTestTemperature;
    @Size(max = 4000)
    @Column(name = "REMARKS")
    private String remarks;
    @Size(max = 50)
    @Column(name = "AVG_LOW_GRADE_TEMPERATURE")
    private String avgLowGradeTemperature;
    @Size(max = 50)
    @Column(name = "MVALUE_SPEC_MIN")
    private String mvalueSpecMin;
    @Size(max = 50)
    @Column(name = "MVALUE_SPEC_MAX")
    private String mvalueSpecMax;
    @Size(max = 50)
    @Column(name = "PASSFAIL_MVALUE")
    private String passfailMvalue;
    @Size(max = 50)
    ...
    @Size(max = 50)
    @Column(name = "CREEP_STIFFNESS")
    private String creepStiffness;
    @Size(max = 50)
    @Column(name = "M_VALUE")
    ...
    public String getLowGradeTemperature() {
        return lowGradeTemperature;
    }

    public void setLowGradeTemperature(String lowGradeTemperature) {
        this.lowGradeTemperature = lowGradeTemperature;
    }
    ...
    public String getAvgCreepStiffness() {
        return avgCreepStiffness;
    }

    public void setAvgCreepStiffness(String avgCreepStiffness) {
        this.avgCreepStiffness = avgCreepStiffness;
    }

    public String getAvgMValue() {
        return avgMValue;
    }

    public void setAvgMValue(String avgMValue) {
        this.avgMValue = avgMValue;
    }

    public String getAvgTestTemperature() {
        return avgTestTemperature;
    }

    public void setAvgTestTemperature(String avgTestTemperature) {
        this.avgTestTemperature = avgTestTemperature;
    }
    ...
    public String getAvgLowGradeTemperature() {
        return avgLowGradeTemperature;
    }

    public void setAvgLowGradeTemperature(String avgLowGradeTemperature) {
        this.avgLowGradeTemperature = avgLowGradeTemperature;
    }

    public String getMvalueSpecMin() {
        return mvalueSpecMin;
    }

    public void setMvalueSpecMin(String mvalueSpecMin) {
        this.mvalueSpecMin = mvalueSpecMin;
    }

    public String getMvalueSpecMax() {
        return mvalueSpecMax;
    }

    public void setMvalueSpecMax(String mvalueSpecMax) {
        this.mvalueSpecMax = mvalueSpecMax;
    }

    public String getPassfailMvalue() {
        return passfailMvalue;
    }

    public void setPassfailMvalue(String passfailMvalue) {
        this.passfailMvalue = passfailMvalue;
    }
    ...
    public String getCreepStiffness() {
        return creepStiffness;
    }

    public void setCreepStiffness(String creepStiffness) {
        this.creepStiffness = creepStiffness;
    }
