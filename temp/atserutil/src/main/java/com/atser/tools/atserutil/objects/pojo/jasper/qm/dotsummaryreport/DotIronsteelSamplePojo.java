 ...
 * @author mfuentes
 */
public class DotIronsteelSamplePojo {
    ...
    public String getSampleNoSeq() {
        return sampleNoSeq;
    }

    public void setSampleNoSeq(String sampleNoSeq) {
    ...
    public String getSubitemEstmQty() {
        return subitemEstmQty;
    }

    public void setSubitemEstmQty(String subitemEstmQty) {
