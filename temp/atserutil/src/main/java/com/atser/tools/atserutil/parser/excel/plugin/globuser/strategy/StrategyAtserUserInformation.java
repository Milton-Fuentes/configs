...
import com.atser.tools.atserutil.parser.excel.plugin.globuser.builder.AtserUserInfTplBuilder;
 ...
 * @author droldan
 */
public class StrategyAtserUserInformation extends UserInformationStrategy {

    public StrategyAtserUserInformation() {
        super();
    }
    ...
    public List<UserInformationDef> getResourceData() throws TemplateDifferentException, ExcelParsingException, EmptyDocumentException {
        if (pPage != null) {
            AtserUserInfTplBuilder pbuilder = new AtserUserInfTplBuilder(pPage);
    ...
    public String getObjectName() {
        return "StrategyAtserUserInformation";
    }
