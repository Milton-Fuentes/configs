...
@Getter
@Setter
public class QaInspectionCertOfSrcTO extends QaInspectionReportTO {

    private InspectionCertOfSrcPojo certInfo;
    private Map<String, InspectionSignaturePojo> signatureList;

    public QaInspectionCertOfSrcTO() {
        super();
        signatureList = new HashMap<>();
    }

    public QaInspectionCertOfSrcTO(InspectionHeaderPojo header, InspectionContractInfoPojo contractInfo) {
