...
public class DotProcT99Pojo {
    ...
    private String specgravityIscalc;
    ...
    public String getHideOnPda() {
        return hideOnPda;
    }

    public void setHideOnPda(String hideOnPda) {
    ...
    public String getSpecgravityIscalc() {
        return specgravityIscalc;
    }

    public void setSpecgravityIscalc(String specgravityIscalc) {
