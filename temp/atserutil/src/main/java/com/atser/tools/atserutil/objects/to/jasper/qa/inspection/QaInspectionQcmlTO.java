...
@Getter
@Setter
public class QaInspectionQcmlTO extends QaInspectionReportTO {

    private InspectionQcmlPojo qcmlInfo;
    private String itemDetermination;
    private Map<String, InspectionSignaturePojo> signatureList;

    public QaInspectionQcmlTO() {
        super();
        signatureList = new HashMap<>();
    }

    public QaInspectionQcmlTO(InspectionHeaderPojo header, InspectionContractInfoPojo contractInfo) {
