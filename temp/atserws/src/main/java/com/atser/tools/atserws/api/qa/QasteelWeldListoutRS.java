...
import com.atser.tools.atserejb.service.qa.test.QasteelWeldListoutService;
 ...
 * @author mfuentes
 */
@Path("/qa/steelweldlistout")
@WsSecured
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@ManageITSegmentRest
@Slf4j
public class QasteelWeldListoutRS implements IBaseWSException {

    @EJB
    private QasteelWeldListoutService service;
    @EJB
    ...
    @POST
    @Path("/crud")
    public Object crud(ManageITRequest<QasteelWeldListout> request) throws JsonParseException, JsonMappingException, IOException {
        if (request != null && request.validate()) {
