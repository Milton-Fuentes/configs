 ...
 * @author droldan
 */
@Path("/qa/concmixdesign")
@WsSecured
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@ManageITSegmentRest
@Slf4j
public class QaconcMixdesignsRS implements IBaseWSException {

    @EJB
    private QaconcMixdesignsService mixDesignService;
    ...
    @POST
    @Path("/crud")
    public Object crud(ManageITRequest<QaconcMixdesigns> request) throws JsonParseException, JsonMappingException, IOException {
        if (request != null && request.validate()) {
