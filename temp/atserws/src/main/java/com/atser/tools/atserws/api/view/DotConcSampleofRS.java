...
import com.atser.tools.atserejb.service.view.DotConcSampleofService;
 ...
 * @author mfuentes
 */
@Path("/view/dotconcsampleof")
@WsSecured
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@ManageITSegmentRest
@Slf4j
public class DotConcSampleofRS implements IBaseWSException {

    @EJB
    DotConcSampleofService dotConcSampleofService;
